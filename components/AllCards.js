      ...
      <div className={styles.card}>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          {Subtitle_En === "SPECIALIST" ? (
            <div className={`${styles.badge} ${styles.badge1}`}>{Subtitle_En}</div>
          ) : Subtitle_En === "CONSULTANT" ? (
            <div className={`${styles.badge} ${styles.badge2}`}>{Subtitle_En}</div>
          ) : Subtitle_En === "RESIDENT" ? (
            <div className={`${styles.badge} ${styles.badge3}`}>{Subtitle_En}</div>
          ) : Subtitle_En === "GENERAL PRACTITIONER" ? (
            <div className={`${styles.badge} ${styles.badge4}`}>{Subtitle_En.slice(0, 10)}...</div>
          ) : null}
        </div>
