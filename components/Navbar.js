...
export default function Navbar() {
 ...
 const handleClickMore=()=>{
  ...
  const selectLanguage=locale === "en" ? `selectLanguage` : ` اختر اللغة`;
   ...
   const  medicalArticles=locale=== "en"? `Medical Articles`:`المقالات الطبية`;
   const  medicalPrograms=locale=== "en"? `Medical Programs`:`البرامج الطبية`;
          ...
          <ul class={styles.navList}>
            ...
            <li>
              ...
              >
                ...
                {/* <div className={isCompanyActive ?styles.activeChildOne:styles.childOne}>
                  <h2 className={styles.companyH2}><a href="#" onClick={handleClickCompany} className={styles.more}> {company}</a></h2>
                ...
                <div className={isMoreActive ?styles.activeChildTwo:styles.childTwo}>
                  <h2 className={styles.companyH2}><a href="#" onClick={handleClickMore} className={styles.more}>{more}</a></h2>
                  <ul>
                    <li>
